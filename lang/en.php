...
return [
    ...
    'auth.identifier_label' => 'Username or email',
    ...
    'auth.2fa_email_heading' => '📧 Code from your email',
    'auth.2fa_email_instructions' => 'We sent a six-digit code to the address on file. It is valid for 10 minutes and can be used only once.',
    'auth.2fa_email_resend' => 'Send a new code',
    'auth.2fa_email_use_instead' => '📧 Request a code by email instead',
    'auth.2fa_email_no_mail' => '🔑 No email? Sign in with a backup code',
    'auth.2fa_email_send_failed' => 'The code could not be sent. Sign in with a backup code and let the administration team know.',
    'auth.2fa_email_send_throttled' => 'Too many codes requested. Please wait 15 minutes or sign in with a backup code.',
