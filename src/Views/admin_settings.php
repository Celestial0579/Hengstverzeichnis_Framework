...
<div class="card">
    ...
    <form action="/admin/settings" method="POST" enctype="multipart/form-data" style="max-width: 600px;">
        ...
        <div class="form-group" style="background: #f8f9fa; padding: 1rem; border-radius: 8px; border: 1px solid #e0e0e0; margin-bottom: 1.5rem;">
            ...
            <small style="color: #666; display: block; margin-top: 0.3rem;">Erlaubte Formate: PNG, SVG, JPG, WEBP (Max. 5 MB).</small>
        </div>
        ...
        <div class="form-group">
            ...
            <small style="color: #666;">Standard falls leer: "Willkommen im [Verbandsname]".</small>
        </div>
        ...
        <div class="form-group">
            ...
            <small style="color: #666;">Wird auf der Startseite (`/`) angezeigt. Unterstützt Markdown (Fett, Links, Aufzählungen).</small>
        </div>
        ...
        <div class="form-group">
            ...
            <small style="color: #666;">Wird auf der öffentlichen Impressums-Seite (`/impressum`) angezeigt.</small>
        </div>
        ...
        <div class="form-group">
            ...
            <small style="color: #666;">Wird auf der öffentlichen Datenschutz-Seite (`/datenschutz`) angezeigt.</small>
        </div>
