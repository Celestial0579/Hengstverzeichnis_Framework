...
return [
    ...
    'auth.identifier_label' => 'Benutzername oder E-Mail',
    ...
    'admin.dashboard.logged_in_as' => 'Angemeldet als:',
    ...
    'admin.dashboard.system_text' => 'Globale Konfigurationen, Branding, E-Mail-Server und Benutzerverwaltung.',
    'admin.dashboard.tile_system_settings' => 'Systemeinstellungen',
    'admin.dashboard.tile_branding' => 'Branding & Erscheinungsbild',
    'admin.dashboard.tile_mail' => 'E-Mail & SMTP Einstellungen',
    'admin.dashboard.tile_users' => 'Benutzer verwalten',
    'admin.dashboard.tile_groups' => 'Gruppen & Berechtigungen',
    'admin.dashboard.tile_gdpr' => 'DSGVO Anfragen',
    'admin.dashboard.tile_logs' => 'Audit-Log (Protokoll)',
    'admin.dashboard.tile_plugins' => 'Plugins verwalten',
    'admin.dashboard.tile_cron' => 'Automatisierung (Cron)',
    ...
    'auth.2fa_email_instructions' => 'Wir haben einen sechsstelligen Code an Ihre hinterlegte Adresse geschickt. Er gilt 10 Minuten und nur ein einziges Mal.',
    'auth.2fa_email_resend' => 'Neuen Code senden',
    'auth.2fa_email_use_instead' => '📧 Stattdessen Code per E-Mail anfordern',
    'auth.2fa_email_no_mail' => '🔑 Keine Mail bekommen? Mit Backup-Code anmelden',
    'auth.2fa_email_send_failed' => 'Der Code konnte nicht versendet werden. Melden Sie sich mit einem Backup-Code an und benachrichtigen Sie das Verwaltungsteam.',
    'auth.2fa_email_send_throttled' => 'Zu viele Codes angefordert. Bitte warten Sie 15 Minuten oder melden Sie sich mit einem Backup-Code an.',
