...
<div class="card" style="max-width: 400px; margin: 4rem auto;">
    <h2 class="text-center" style="margin-bottom: 0.5rem;">🔐 2FA Bestätigung</h2>
    <p class="text-center" style="color: #666; font-size: 0.95rem; margin-bottom: 1.5rem;">
        Bitte geben Sie den 6-stelligen Code aus Ihrer Authentikator-App ein.
    </p>
    ...
    <form action="/login/2fa" method="POST">
        ...
        <div class="form-group" style="text-align: center;">
            <label for="totp_code" style="display: block; margin-bottom: 0.5rem;">6-stelliger Code</label>
        ...
        <button type="submit" class="btn" style="width: 100%; margin-top: 1rem;">Anmelden</button>
    </form>
