...
<div class="card" style="max-width: 650px; margin: 2rem auto;">
    ...
    <form action="/2fa/enable" method="POST">
        ...
        <div class="form-group" style="margin-bottom: 1.5rem;">
            <label style="display: flex; align-items: center; gap: 0.5rem; font-weight: bold; cursor: pointer; color: #dc3545;">
        ...
        <h3 style="color: var(--primary-color); margin-bottom: 0.5rem;">Schritt 3: Verifizierung</h3>
